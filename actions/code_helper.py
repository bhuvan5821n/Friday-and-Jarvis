...
def _get_gemini(model: str = GEMINI_MODEL):
    # All AI goes through OmniRoute now — it picks the best coding model
    # (and the pro tier automatically in battle mode). Same interface.
    from core.ai import OmniModel
    return OmniModel(task="coding")
...
Be specific and actionable. If you see an error message, quote it exactly."""
        ...
        response = OmniModel(task="vision").generate_content(
            [image_bytes, analysis_prompt])
